...
(function () {
    ...
    dawn.BorderedRectangleGeometry = function (width, height, border, uv) {
        uv = uv || new dawn.vec4(0, 1, 0, 1);
        prepareObject(this, libdawn.borderedrectanglegeometry_create(width, height, obj2ptr(border), obj2ptr(uv)));
        ...
        prepare_prop(this, 'borderedrectanglegeometry', 'border', border, obj2ptr);
    };
